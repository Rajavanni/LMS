...
const EditFaq = (props: Props) => {
  ...
  useEffect(() => {
    if (data && data.layout) {
      setQuestions(data.layout.faq || []); // Set questions to an empty array if data.layout.faq is null or undefined
    }
    if(layoutSuccess){
  ...
  const handleEdit = async () => {
    if (
      !areQuestionsUnchanged(data?.layout?.faq || [], questions) && // Check for null or undefined
