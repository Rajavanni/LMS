      ...
      <div className="w-full flex justify-center">
        <div className="relative">
          ...
          <label htmlFor="avatar">
            <div className="w-[30px] h-[30px] bg-slate-200 rounded-full absolute bottom-2 right-2 flex items-center justify-center cursor-pointer">
              <AiOutlineCamera size={20} className="z-1 text-black" />
            </div>
          </label>
        </div>
      </div>
